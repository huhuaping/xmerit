...
[`opt_line()`](https://huhuaping.github.io/xmerit/dev/reference/opt_line.md)
...
[`opt_line()`](https://huhuaping.github.io/xmerit/dev/reference/opt_line.md)，例如：
...
更多细节见函数帮助：[`?opt_line`](https://huhuaping.github.io/xmerit/dev/reference/opt_line.md)。
